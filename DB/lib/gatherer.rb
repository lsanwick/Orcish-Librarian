...
class Gatherer < Source
  ...
  @@sets = {
    ...
    "Duel Decks: Elves vs. Goblins" => { :tcg => "Duel Decks: Elves vs. Goblins", :type => SpecialSet, :display => "Elves vs. Goblins" },
    "Duel Decks: Jace vs. Chandra" => { :tcg => "Duel Decks: Jace vs. Chandra", :type => SpecialSet, :display => "Jace vs. Chandra" },
    "Duel Decks: Divine vs. Demonic" => { :tcg => "Duel Decks: Divine vs. Demonic", :type => SpecialSet, :display => "Divine vs. Demonic" },
    "Duel Decks: Garruk vs. Liliana" => { :tcg => "Duel Decks: Garruk vs. Liliana", :type => SpecialSet, :display => "Garruk vs. Liliana" },
    "Duel Decks: Phyrexia vs. the Coalition" => { :tcg => "Duel Decks: Phyrexia vs. the Coalition", :type => SpecialSet, :display => "Phyrexia vs. the Coalition" },
    "Duel Decks: Elspeth vs. Tezzeret" => { :tcg => "Duel Decks: Elspeth vs. Tezzeret", :type => SpecialSet, :display => "Elspeth vs. Tezzeret" },
    "Duel Decks: Knights vs. Dragons" => { :tcg => "Duel Decks: Knights vs Dragons", :type => SpecialSet, :display => "Knights vs. Dragons" },
    "Duel Decks: Ajani vs. Nicol Bolas" => { :tcg => "Duel Decks: Ajani vs. Nicol Bolas", :type => SpecialSet, :display => "Ajani vs. Nicol Bolas" },
    "Duel Decks: Venser vs. Koth" => { :tcg => "Duel Decks: Venser vs. Koth", :type => SpecialSet, :display => "Venser vs. Koth" },
    "From the Vault: Dragons" => { :tcg => "From the Vault: Dragons", :type => SpecialSet, :display => "FtV: Dragons" },
    "From the Vault: Exiled" => { :tcg => "From the Vault: Exiled", :type => SpecialSet, :display => "FtV: Exiled" },
    "From the Vault: Relics" => { :tcg => "From the Vault: Relics", :type => SpecialSet, :display => "FtV: Relics" },
    "From the Vault: Legends" => { :tcg => "From the Vault: Legends", :type => SpecialSet, :display => "FtV: Legends" },
    "Premium Deck Series: Slivers" => { :tcg => "Premium Deck Series: Slivers", :type => SpecialSet, :display => "Slivers" },
    "Premium Deck Series: Fire and Lightning" => { :tcg => "Premium Deck Series: Fire and Lightning", :type => SpecialSet, :display => "Fire & Lightning" },
    "Premium Deck Series: Graveborn" => { :tcg => "Premium Deck Series: Graveborn", :type => SpecialSet, :display => "Graveborn" },
    ...
    "Limited Edition Alpha"         => { :tcg => "Alpha Edition", :type => CoreSet, :format => Legacy, :display => "Alpha" },
    "Limited Edition Beta"          => { :tcg => "Beta Edition", :type => CoreSet, :format => Legacy, :display => "Beta"  },
    "Unlimited Edition"             => { :tcg => "Unlimited Edition", :type => CoreSet, :format => Legacy, :display => "Unlimited" },
    ...
    "Revised Edition"               => { :tcg => "Revised Edition", :type => CoreSet, :format => Legacy, :display => "Revised" },
    ...
    "Fourth Edition"                => { :tcg => "Fourth Edition", :type => CoreSet, :format => Legacy, :display => "4th Edition" },
    ...
    "Fifth Edition"                 => { :tcg => "Fifth Edition", :type => CoreSet, :format => Legacy, :display => "5th Edition" },
    ...
    "Classic Sixth Edition"         => { :tcg => "Classic Sixth Edition", :type => CoreSet, :format => Legacy, :display => "6th Edition" },
    ...
    "Seventh Edition"               => { :tcg => "7th Edition", :type => CoreSet, :format => Legacy, :display => "7th Edition" },
    ...
    "Eighth Edition"                => { :tcg => "8th Edition", :type => CoreSet, :format => Modern, :display => "8th Edition" },
    ...
    "Ninth Edition"                 => { :tcg => "9th Edition", :type => CoreSet, :format => Modern, :display => "9th Edition" },
    "Ravnica: City of Guilds"       => { :tcg => "Ravnica", :type => ExpansionSet, :format => Modern, :display => "Ravnica" },
    ...
    "Tenth Edition"                 => { :tcg => "10th Edition", :type => CoreSet, :format => Modern, :display => "10th Edition" },
