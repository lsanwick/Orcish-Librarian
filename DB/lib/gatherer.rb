...
class Gatherer < Source
  ...
  @@sets = {
    ...
    "Limited Edition Beta"          => { :tcg => "Beta Edition", :type => CoreSet, :format => Legacy },
    ...
    "Classic Sixth Edition"         => { :tcg => "Classic Sixth Edition", :type => CoreSet, :format => Legacy },
    ...
    "Time Spiral \"Timeshifted\""   => { :tcg => "Timeshifted", :type => ExpansionSet, :format => Modern },
